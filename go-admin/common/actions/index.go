...
type UserInfoSearch struct {
	UserName string `form:"userName" search:"type:contains;column:user_name;table:user_info" comment:"	 用户名"`
	PhoneNum string `form:"phoneNum" search:"type:contains;column:phone_num;table:user_info" comment:"电话号"`
}
